        ...
        <div className="contact-panel" data-reveal>
          ...
          <div className="direct-contact-block" id="contact">
            ...
            <div className="contact-channels" aria-label="Direct contact options">
              <a href="viber://chat/?number=%2B639473068528" className="contact-channel channel-viber" aria-label="Open Viber chat with J3C">
              ...
              <a href="https://www.messenger.com/t/1567965688161013/" target="_blank" rel="noreferrer" className="contact-channel channel-messenger" aria-label="Contact J3C through Messenger">
                <span className="channel-brand-icon" aria-hidden="true">
